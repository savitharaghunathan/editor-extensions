...
| JAVASCRIPT_VSIX_FILE_PATH | (Optional) Path to the JavaScript extension in vsix format.                                                                                                                                                                                                           |
| GO_VSIX_FILE_PATH      | (Optional) Path to the Go extension in vsix format.                                                                                                                                                                                                           |
| CORE_VSIX_DOWNLOAD_URL | (Optional) URL to get vsix from (only used if CORE_VSIX_FILE_PATH is not defined)                                                                                                                                                                               |
